...
export const PROCESS_LINE_SORT_FIELDS = [
  'code',
  'nameTh',
  'isActive',
  'createdAt',
...
export type ProcessLineSortBy = (typeof PROCESS_LINE_SORT_FIELDS)[number];
export type ProcessLineSortOrder = 'asc' | 'desc';
...
export class ListProcessLinesQueryDto {
  @Type(() => Number)
  @IsInt()
  @Min(1)
  page: number = 1;
  ...
  @IsIn(PROCESS_LINE_SORT_FIELDS)
  sortBy: ProcessLineSortBy = 'code';

  @IsIn(['asc', 'desc'])
  sortOrder: ProcessLineSortOrder = 'asc';
}
