...
export const PRODUCT_MODEL_SORT_FIELDS = [
  'code',
  'nameTh',
  'isActive',
  'createdAt',
...
export type ProductModelSortBy = (typeof PRODUCT_MODEL_SORT_FIELDS)[number];
export type ProductModelSortOrder = 'asc' | 'desc';
...
export class ListProductModelsQueryDto {
  @Type(() => Number)
  @IsInt()
  @Min(1)
  page: number = 1;
  ...
  @IsIn(PRODUCT_MODEL_SORT_FIELDS)
  sortBy: ProductModelSortBy = 'code';

  @IsIn(['asc', 'desc'])
  sortOrder: ProductModelSortOrder = 'asc';
}
