...
export const MATERIAL_MODEL_SORT_FIELDS = [
  'code',
  'nameTh',
  'isActive',
  'createdAt',
...
export type MaterialModelSortBy = (typeof MATERIAL_MODEL_SORT_FIELDS)[number];
export type MaterialModelSortOrder = 'asc' | 'desc';
...
export class ListMaterialModelsQueryDto {
  @Type(() => Number)
  @IsInt()
  @Min(1)
  page: number = 1;
  ...
  @IsIn(MATERIAL_MODEL_SORT_FIELDS)
  sortBy: MaterialModelSortBy = 'code';

  @IsIn(['asc', 'desc'])
  sortOrder: MaterialModelSortOrder = 'asc';
}
