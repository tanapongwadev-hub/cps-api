...
describe('LocationsService', () => {
  ...
  describe('create', () => {
    it('normalizes code, trims strings, saves audit ids', async () => {
      ...
      expect(result.code).toBe('LOC-01');
    });
    ...
    it('throws ConflictException on duplicate code', async () => {
      ...
      await expect(
        service.create({ code: 'LOC-01', nameTh: 'คลัง A' } as any, 'u'),
  ...
  describe('update', () => {
    ...
    it('applies update and stamps updatedBy', async () => {
      ...
      const result = await service.update(
        '1',
        { nameTh: 'คลัง B', updatedAt: '2026-08-04T00:00:00.000Z' },
        'user-2',
      );
      expect(result.nameTh).toBe('คลัง B');
