...
export const LOADING_POINT_SORT_FIELDS = [
  'code',
  'nameTh',
  'isActive',
  'createdAt',
...
export type LoadingPointSortBy = (typeof LOADING_POINT_SORT_FIELDS)[number];
export type LoadingPointSortOrder = 'asc' | 'desc';
...
export class ListLoadingPointsQueryDto {
  @Type(() => Number)
  @IsInt()
  @Min(1)
  page: number = 1;
  ...
  @IsIn(LOADING_POINT_SORT_FIELDS)
  sortBy: LoadingPointSortBy = 'code';

  @IsIn(['asc', 'desc'])
  sortOrder: LoadingPointSortOrder = 'asc';
}
