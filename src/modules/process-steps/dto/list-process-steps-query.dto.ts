...
export const PROCESS_STEP_SORT_FIELDS = [
  'code',
  'nameTh',
  'isActive',
  'createdAt',
...
export type ProcessStepSortBy = (typeof PROCESS_STEP_SORT_FIELDS)[number];
export type ProcessStepSortOrder = 'asc' | 'desc';
...
export class ListProcessStepsQueryDto {
  @Type(() => Number)
  @IsInt()
  @Min(1)
  page: number = 1;
  ...
  @IsIn(PROCESS_STEP_SORT_FIELDS)
  sortBy: ProcessStepSortBy = 'code';

  @IsIn(['asc', 'desc'])
  sortOrder: ProcessStepSortOrder = 'asc';
}
