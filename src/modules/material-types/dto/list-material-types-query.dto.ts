...
export const MATERIAL_TYPE_SORT_FIELDS = [
  'code',
  'nameTh',
  'isActive',
  'createdAt',
...
export type MaterialTypeSortBy = (typeof MATERIAL_TYPE_SORT_FIELDS)[number];
export type MaterialTypeSortOrder = 'asc' | 'desc';
...
export class ListMaterialTypesQueryDto {
  ...
  @IsIn(MATERIAL_TYPE_SORT_FIELDS)
  sortBy: MaterialTypeSortBy = 'code';

  @IsIn(['asc', 'desc'])
  sortOrder: MaterialTypeSortOrder = 'asc';
}
